...
interface CreateOptionProps {
  id: string;
  onSaveOption: (option: Omit<TaskOption, "isCorrect">) => void;
  onRemoveOption: (id: string) => void;
}

const CreateOption: React.FC<CreateOptionProps> = ({id, onSaveOption, onRemoveOption}) => {
  const [questOptionData, setQuestOptionData] = useState<Omit<TaskOption, "isCorrect">>({
    id: id,
    text: ''
  });
